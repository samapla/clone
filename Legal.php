                        ...
                        <ul class="nav  navbar-nav">
                            ...
                            <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="Legal.html">Legal, NPO, PBO Status</a></li>
                ...
                <div class="row">
                    <div class='col-md-7'>
                        ...
                        <div class="box-1">
                            ...
                            <div></div>
                            <div class=''>
                                <h1>Legal, NPO, PBO StatusHome</h1>
                            </div>
                            <div class='paragraph'>
                                <p><b>The Homestead is a registered Public Benefit 
                                        Organisation:</b>  <a href="https://thehomestead.org.za/wp-content/uploads/2014/02/PBO-Registration.pdf">PBO Registration Letter:</a>   
                                    <br/>Donations of funds to the Homestead, 
                                    PBO 18/11/13/1038 allows South African companies
                                    and<br/>  individuals to deduct the value of your donation 
                                    from your taxable income. This is a significant<br/> benefit  
                                    and will be deductible if the donation: Is supported by a 
                                    donation certificate (The Homestead <br/> issues official 
                                    section 18a reciepts); and your donation does not  exceed 
                                    10 percent of the taxable<br/> income of the taxpayer calculated .</p>

                                <p><b>The Homestead is a registered Non Profit Organisation:</b>

                                    <img src="images/Homestead-NPO-certificate.jpg" class="certificate"/>
                                </p>
                            </div>
                    ...
                    <div class='col-md-5'>
                        <div class="box-2">
                            ...
                            <br/><br/>
                            <p> <a href="outreach.html">STREET OUTREACH</a><br/><br/>
                                <a href="intake.html">THE HOMESTEAD INTAKE SHELTER</a><br/><br/>
                                <a href="prevention.html">PREVENTION</a> <br/><br/>
                                <a href="children.html">THE HOMESTEAD CHILDREN'S HOME</a><br/><br/>
